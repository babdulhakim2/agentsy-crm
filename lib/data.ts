// Sample data fixtures — Forge Group, typed.
// Ported verbatim from the original design canvas.
  ...
  reviews: [
    {
      ...
      age: "2h",
      excerpt:
        "Loved the lamb, service a bit slow at the start but the team made up for it. Will be back.",
      draft:
        "Hi Sarah — thank you for the lovely note about the lamb. You're right that we were a touch slow on the open; we've had a word with the team. Really hope to see you again soon. — Maya",
      sentiment: "positive",
    },
    {
      id: "r2",
      ...
      age: "5h",
      excerpt:
        "Felt rushed, wine was warm, the table next to us was very loud. Not what I'd hoped for a Friday.",
      draft:
        "Daniel, I'm sorry — that's not the night we wanted you to have. The wine should never go out warm and we're following up with the team about the pacing. I'd love the chance to put it right; please drop me a note when you're next free.",
      sentiment: "negative",
      flagged: true,
    },
  ],
  ...
  winbacks: [
    {
      ...
      tag: "Wine drinker",
      draft:
        "Olu — it's been a minute. The new spring menu lands Thursday and there's a Côtes du Rhône on the list with your name on it. Want me to hold a Friday two-top?",
    },
    {
      id: "w2",
      name: "Priya Shah",
    ...
    },
    {
      ...
      tag: "Regulars",
      draft:
        "Tom and Rachel — long time. The chef put a brown-butter tagliatelle on this week that I think you'd both lose your minds over. Saturday seven-thirty?",
    },
    {
      id: "w4",
      name: "Marcus Lee",
      ...
      tag: "Wine drinker",
      draft:
        "Marcus — quick one: there's a small natural-wine pour-up on Wednesday, no charge. Want me to put your name down?",
    },
    {
      id: "w5",
      name: "Aisha Khan",
      ...
      tag: "VIP",
      draft:
        "Aisha — we miss you. The room's quieter mid-week if you fancy a calmer evening. Tuesday or Wednesday work?",
    },
  ],
  ...
  social: [
    {
      id: "s1",
      site: "Hackney",
      kind: "Instagram caption",
      draft:
        "Brown butter, capers, a quiet Tuesday. The lamb is back on Thursday — first come, no holds.",
    },
  ],
  ...
  anomalies: [
    {
      id: "a1",
      kind: "Integration",
      label: "Square integration paused",
      detail:
        "Square logged us out at 06:14 this morning. Reconnecting takes about 60 seconds. While it's down, spend data is frozen on yesterday's totals.",
    },
  ],
